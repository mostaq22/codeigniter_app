                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        *************************************
                        ...
                        <!-- Extra Fields -->
                            <div class="form-group"><label class="col-lg-2 control-label">Controller Name</label>
                                <div class="col-lg-10">
                                <?php $controller_option[0] = '';?>
                                    <?= form_dropdown('controller_id',$controller_option,$render['controller_id'],'id="controller_id" class="searchable-option form-control"') ?>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
